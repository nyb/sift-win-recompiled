...
/* Calculates the inner_product of two festure descriptors.*/
double descr_inner_product(struct feature* f1, struct feature* f2)
{
	double product=0;
	double* descr1, * descr2;
	int i,d;
	...
	for( i = 0; i < d; i++ )
	{
		product+=descr1[i] * descr2[i];
	}
	return product;
}

double E_distance(struct feature* f1)
{
	double distance=0;
	double* descr1;
	int i,d;
